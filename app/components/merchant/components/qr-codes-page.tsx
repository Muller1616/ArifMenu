          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="pt-4 border-t">
                <h3 className="font-medium text-gray-900 mb-2">QR Code Features</h3>
                <ul className="text-sm text-gray-600 space-y-1">
                  <li>• High resolution for print quality</li>
                  <li>• Customizable URL and menu name</li>
                  <li>• Instant regeneration capability</li>
          ...
          <Card>
            ...
            <CardContent className="space-y-3 text-sm text-gray-600">
              <div className="flex items-start gap-3">
                ...
                <p>Test the QR code by scanning it with your phone to ensure it directs to the correct menu.</p>
              </div>
              <div className="flex items-start gap-3">
                <div className="w-6 h-6 bg-green-100 text-green-600 rounded-full flex items-center justify-center text-xs font-bold flex-shrink-0 mt-0.5">
                  2
                </div>
                <p>Download the QR code and rename the file to match the merchant's name for easy identification.</p>
              </div>
              <div className="flex items-start gap-3">
                <div className="w-6 h-6 bg-green-100 text-green-600 rounded-full flex items-center justify-center text-xs font-bold flex-shrink-0 mt-0.5">
                  3
                </div>
                <p>Print the QR code at high resolution and place it prominently in your restaurant.</p>
              </div>
            </CardContent>
          </Card>
        </div>
