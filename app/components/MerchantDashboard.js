...
export default function MerchantDashboard({ user, onLogout, onShowCustomerApp }) {
...
const renderPage = () => {
  switch (currentPage) {
    ...
    case "merchants":
      return <MerchantsPage onNavigateToAddMerchant={() => setCurrentPage("add-merchant")} /> // Pass navigation prop
    case "add-merchant": // New case for AddMerchantPage
      return <AddMerchantPage onNavigateBack={() => setCurrentPage("merchants")} />
    case "transactions":
